...
{
    //Контролер для обробки запитів від головної сторінки, сторінки адміна, та оформлення підписки
    public class HomeController : Controller
    {
        ...
        public ActionResult Subscription()
        {
            ...
            SubscriptionPresentationModel svm = new SubscriptionPresentationModel
            {
        ...
        [HttpPost]
        public ActionResult Subscription(SubscriptionPresentationModel svm)
        {
